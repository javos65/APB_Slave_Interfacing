...
- APB to SPI ( 4 wire SPI with DC interface for OLED drive, incl drivers SSD1351) <br>
- APB to ADC (Dual ADC, continous conversion, 1.2V Vref, 4 Memory mapped locations) <br><br>
 Tested with MAS Educational Board -> link[[https://maselettronica.com/product/mas-educational-board-certus-pro-nx/?lang=en](https://maselettronica.com/products/certuspro-tm-nx-mas-educational-board)]<BR>
